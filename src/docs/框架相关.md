...
keyword: ["qiankun", "vue", "react"]
description: "前端框架是一套提供了标准结构和工具集的JavaScript库，用于简化复杂用户界面的开发。它们主要解决简化直接操作DOM的复杂性、管理应用数据状态的变化和同步等"
nav: 文章
order: 1
group:
  title: 概念&原理
