---
title: "网络相关"
date: "2025-11-08 10:11:22"
keyword: ["HTTP", "Axios", "WebSocket", "安全"]
description: "前端网络相关指的是在前端开发中所有与网络通信、数据传输、性能优化相关的技术和概念。"
nav: 文章
order: 2
group:
  title: 概念&原理
...
### Q1. http1.0、http1.1、http2.0、http3.0各有什么特点？
* http1.0: 
