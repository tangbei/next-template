...
keyword: ["事件循环", "ES Modules", "CommonJS", "性能优化"]
description: "现代前端开发离不开 Node.js，全栈能力成为标配，如React/Vue 界面开发、Node.js API/中间层、Docker、CI/CD 脚本"
nav: 文章
order: 4
group:
  title: 概念&原理
...
### Q1. express+node使用doctor部署后，如果挂了怎么办？
